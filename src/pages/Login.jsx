          ...
          <div className="max-w-[320px] mx-auto py-16">
            ...
            <form onSubmit={handleSubmit} className="w-full flex flex-col py-4">
              <input
                ...
                className="p-3 my-3 bg-gray-600 rounded"
                type="email"
                placeholder="Email"
                autoComplete="email"
              />
              ...
              />
              <button className="bg-white text-black py-3 my-6 rounded font-bold">
                Sign In
              </button>
              ...
              <p className="py-10 text-sm">
                <span className="text-[darkgray]">New to Global Beats?</span>{' '}
